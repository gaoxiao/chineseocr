...
RUN /root/anaconda3/bin/pip install easydict opencv-python==4.1.2.30 Cython h5py pandas requests bs4 matplotlib lxml -U pillow keras==2.1.5 tensorflow-gpu==1.8 -i https://pypi.tuna.tsinghua.edu.cn/simple/
RUN /root/anaconda3/bin/pip install web.py==0.40.dev0
RUN echo -e "\ny" | /root/anaconda3/bin/conda install pytorch torchvision -c pytorch
